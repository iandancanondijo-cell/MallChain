...
export default function Landing({ navigate }: LandingProps) {
  ...
  return (
    <div className="landing-page">
              ...
              <div className="mock-dashboard-body">
                <div className="mock-stat-row">
                  <div className="mock-stat">
                    ...
                    <span className="mock-stat-change mock-up">+4.2% today</span>
                  </div>
                  <div className="mock-stat">
                    <span className="mock-stat-label">Mallpoints</span>
                    <span className="mock-stat-value">3,600 MLPTS</span>
                    <span className="mock-stat-change">≈ KSh 7,200</span>
                  </div>
                </div>
      ...
      <section className="features-section" id="goals">
      ...
      <section className="spotlight-section" id="trust">
      ...
      <section className="spotlight-section spotlight-reverse">
        <div className="spotlight-grid">
          <div className="spotlight-visual">
            <div className="spotlight-glow" aria-hidden="true" />
            <div className="mock-card">
