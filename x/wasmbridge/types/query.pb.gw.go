...
var (
	pattern_Query_Balance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"marketplace", "wasmbridge", "v1", "balance", "address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Allowance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"marketplace", "wasmbridge", "v1", "allowance", "owner", "spender"}, "", runtime.AssumeColonVerbOpt(false)))
)
