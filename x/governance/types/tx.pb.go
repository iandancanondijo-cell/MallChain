...
// MsgSlashValidator slashes a validator by slash_percentage (0-100) of its
// current stake. Only valid as a message attached to a passed governance
// proposal — authority must be this module's governance address.
type MsgSlashValidator struct {
	// authority is the address that controls the module (defaults to x/gov unless overwritten).
	Authority string `protobuf:"bytes,1,opt,name=authority,proto3" json:"authority,omitempty"`
	// validator_address is the operator address (valoper) of the validator to slash.
	ValidatorAddress string `protobuf:"bytes,2,opt,name=validator_address,json=validatorAddress,proto3" json:"validator_address,omitempty"`
	// slash_percentage is the percentage (0-100) of the validator's current
	// stake to slash.
	SlashPercentage uint64 `protobuf:"varint,3,opt,name=slash_percentage,json=slashPercentage,proto3" json:"slash_percentage,omitempty"`
}
...
func (*MsgSlashValidator) Descriptor() ([]byte, []int) {
	return fileDescriptor_abb109eb8c4caff0, []int{10}
}
...
func (m *MsgSlashValidator) GetSlashPercentage() uint64 {
	if m != nil {
...
// MsgSlashValidatorResponse defines the response structure for executing a
// MsgSlashValidator message.
...
func (*MsgSlashValidatorResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_abb109eb8c4caff0, []int{11}
}
...
func init() {
	...
	proto.RegisterType((*MsgSlashValidator)(nil), "marketplace.governance.v1.MsgSlashValidator")
	proto.RegisterType((*MsgSlashValidatorResponse)(nil), "marketplace.governance.v1.MsgSlashValidatorResponse")
}
...
var fileDescriptor_abb109eb8c4caff0 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	// SlashValidator slashes a validator's stake. Only executable as a message
	// attached to a passed proposal (authority-gated, like UpdateParams) —
	// this is how governance-triggered validator slashing is actually
	// reachable; SlashValidatorProposal alone has no caller.
...
func (c *msgClient) SlashValidator(ctx context.Context, in *MsgSlashValidator, opts ...grpc.CallOption) (*MsgSlashValidatorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/marketplace.governance.v1.Msg/SlashValidator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SlashValidator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/marketplace.governance.v1.Msg/SlashValidator",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgSlashValidator) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SlashPercentage != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.SlashPercentage))
		i--
		dAtA[i] = 0x18
	}
...
func (m *MsgSlashValidator) Size() (n int) {
	...
	if m.SlashPercentage != 0 {
		n += 1 + sovTx(uint64(m.SlashPercentage))
	}
	return n
}
