...
var (
	...
	appConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			// Standard module configs...
			{Name: authtypes.ModuleName, Config: appconfig.WrapAny(&authmodulev1.Module{
			...
			{Name: group.ModuleName, Config: appconfig.WrapAny(&groupmodulev1.Module{
			...
			{Name: mallcoinmoduletypes.ModuleName, Config: appconfig.WrapAny(&mallcoinmoduletypes.Module{})},
